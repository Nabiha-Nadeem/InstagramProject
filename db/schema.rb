...
ActiveRecord::Schema.define(version: 20_220_810_024_546) do
  # These are extensions that must be enabled in order to support this database
  enable_extension 'plpgsql'
  create_as_attachments_table
  create_as_blobs_table
...
def create_as_attachments_table
